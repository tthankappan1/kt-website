...
export const post: Post = {
  slug: 'down-payment-surprise',
  title: `The Down Payment Surprise: Why Buyers Are Getting In With Less Right Now`,
  category: 'Market Update',
  date: '2026-07-02',
  excerpt: `Down payments just hit their lowest level since 2021 — and between assistance programs you may already qualify for and a hand from family, the door may be closer than you think.`,
  body: [
    ...
    { h: `Down Payments Just Hit Their Lowest Since 2021` },
    ...
    { h: `Help You May Not Know You Qualify For` },
    ...
    { chart: {
      ...
      "bars": [
        {
          "label": "Qualify for down payment assistance",
          "value": 44
        },
        {
          "label": "Actually use down payment assistance",
          "value": 10
        }
      ]
    } },
    ...
    { cta: `Curious what this looks like for your budget and your target neighborhood? Call or text me — I’ll connect you with a trusted local lender and map out exactly what you’d need to get in the door here in the Bay Area.` },
